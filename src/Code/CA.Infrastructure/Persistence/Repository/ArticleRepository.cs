...
{
  public class ArticleRepository : BaseRepository<Article, int, PatosaDbContext>, IArticleRepository<PatosaDbContext>
  {
    ...
    public void DeleteArticle(Article obj) => DeleteArticle(obj);
    ...
    public void UpdateArticle(Article obj) => UpdateArticle(obj);
  }
}
