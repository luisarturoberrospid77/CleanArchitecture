...
namespace CA.Infrastructure.Common.Repositories
{
                                            ...
                                            ICountryDetailRepository<PatosaDbContext>
    {
        ...
        public async Task<IEnumerable<CountryDetail>> GetCountryDetailsAsync(CancellationToken cancellationToken = default) =>
        ...
        public async Task<IEnumerable<CountryDetail>> GetPagedCountryDetailsAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default) =>
